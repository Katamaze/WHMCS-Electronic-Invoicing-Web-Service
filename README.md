...
Third. Click the orange button to randomly generate a token to secure transmissions via web service. Note down the token and use this [sample code](https://github.com/Katamaze/WHMCS-Electronic-Invoicing-Web-Service/blob/master/example/Basic.php) as reference.
